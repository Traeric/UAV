package com.eric.uav.voice.recog.listener;
...
import com.eric.uav.voice.recog.RecogResult;
import com.eric.uav.voice.recog.event_handler.EventHandler;
import com.eric.uav.voice.recog.event_handler.SimpleEventHandler;
...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public void onAsrFinalResult(String[] results, RecogResult recogResult) {
        ...
        // 识别结束
        EventHandler eventHandler = new SimpleEventHandler(context);
        eventHandler.assignEvent(results[0]);
    }
